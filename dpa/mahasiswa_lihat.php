...
if(isset($_GET['id']))
{
    ...
    $sql = "SELECT result.*, mahasiswa.nama, mahasiswa.nim, mahasiswa.indeks_prestasi, tipe_kepribadian.nama as tipe_kepribadian, tipe_kepribadian.deskripsi 
    ...
    <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <label>IPK :</label>
                    <input readonly type="text" class="form-control"  placeholder="IPK" value="<?php echo $data['indeks_prestasi']?>">
                </div>
                <div class="form-group">
                ...
                <div class="next" style="float: right;">
                    ...
                    if($data['id_result']!=""){
                    ?>
                    <a href="index.php?hal=mahasiswa_detail&id=<?php echo $id_mahasiswa; ?>&idResult=<?php echo $data['id_result']; ?>">
            ...
            ?>
                ...
                <table id="mahasiswa"  class="table table-display table-striped" width="100%">
                  <thead>
                    <tr>
                      <th width="10%">No</th>
            ...
            ?> 
                    <tr>
                        ...
                        <td>
                        <a href="index.php?hal=mahasiswa_detail&id=<?php echo $id_mahasiswa; ?>&idResult=<?php echo $hasil_result['id_result']; ?>&tipe=sebelumnya">
                        <button style="padding: 10px; margin-top: 20px; background-color: #bfa145; color: black;" type="button">Detail</button>
                        </a>
                        </td>
                    </tr>
